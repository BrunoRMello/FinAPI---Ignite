...
const app = express();
/**Adicionar o middleware para pode trabalhar com json envio e recebimento */
...
/**
 * Criar conta: cpf -string
 * name- string
 * id - uuid
 * statement(extrato ou lançamento) - [] "array"
 */
app.post("/account", (request, response) => {
  // inserção de parametro request.body
...
/**Buscar extrato do client com router params */
...
app.delete("/account", verifyExistsAccountCPF, (request, response) => {
  ...
  //splice    1 é posição do customer que é apenas 1
